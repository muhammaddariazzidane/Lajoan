    ...
    <div class="py-12 px-12 bg-white rounded-2xl shadow-xl z-20">
      ...
      <form action="<?= base_url('auth/register') ?>" method="post">
        <div class="space-y-4">
          ...
          <input type="text" name="password1" id="" placeholder="Password" class="block text-sm py-3 px-4 rounded-lg w-full border outline-none" />
          <input type="text" name="password2" id="" placeholder="Confirm Password" class="block text-sm py-3 px-4 rounded-lg w-full border outline-none" />
        </div>
